    ...
    public void RefreshSpriteOnly()
    {
        ...
        switch (type)
        {
            case ObjectType.Wall:
                if (wallSprite) _spriteRenderer.sprite = wallSprite;
                break;
            case ObjectType.Rock:
                if (rockSprite) _spriteRenderer.sprite = rockSprite;
                break;
            case ObjectType.Man:
                if (manSprite) _spriteRenderer.sprite = manSprite;
                break;
            case ObjectType.Cherry:
                if (cherrySprite) _spriteRenderer.sprite = cherrySprite;
                break;
        }
    }
